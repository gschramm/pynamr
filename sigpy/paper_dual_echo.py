...
pdir = Path('/data/sodium_mr/20230316_MR3_GS_QED/pfiles/g16/recons_128')

r1 = np.abs(
    np.load(pdir / 'recon_echo_1_no_decay_model_L2_1.0E-01_1000.npz')['x'])
r2 = np.abs(
    np.load(pdir / 'recon_echo_2_no_decay_model_L2_1.0E-01_1000.npz')['x'])

ratio = r2 / (r1 + 0.01)

ims = dict(origin='lower')
